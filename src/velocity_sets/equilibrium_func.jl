...
function f_eq_kernel!(lattice::Lattice, d2q9::D2Q9{Compressible})
    ...
    lattice.f_eq[1] = d2q9.w[1] * (rho - usq)
    lattice.f_eq[2] = d2q9.w[2] * (rho + 3. * ueqxij + 4.5 * uxsq - usq)
    lattice.f_eq[3] = d2q9.w[3] * (rho + 3. * ueqyij + 4.5 * uysq - usq)
    lattice.f_eq[4] = d2q9.w[4] * (rho - 3. * ueqxij + 4.5 * uxsq - usq)
    lattice.f_eq[5] = d2q9.w[5] * (rho - 3. * ueqyij + 4.5 * uysq - usq)
